...
export default function AnomalyPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-xl font-bold text-[var(--text-strong)]">이상 탐지</h1>
      ...
      <div className="flex items-center gap-3 flex-wrap">
        <select
          ...
          className="bg-[var(--border)] text-[var(--muted2)] text-sm rounded-lg px-3 py-2 outline-none"
        >
        ...
        <span className="text-sm text-[var(--muted)]">{events.length}건</span>
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div>
          ...
          <div className="bg-[var(--surface)] border border-[var(--border)] rounded-xl p-4 space-y-4">
            <div>
              <div className="text-xs text-[var(--muted)] mb-2">코팅 공정 (Line 1)</div>
              <HeatMap lineId={1} station="coating" />
            </div>
            <div>
              <div className="text-xs text-[var(--muted)] mb-2">캘린더링 공정 (Line 1)</div>
